...
from route import care_team, caregiver_notes, internal_cron, patient_tasks, reminders, remivox, visit_summary, users
...
app.include_router(remivox.router)            # RemiVox voice assistant
