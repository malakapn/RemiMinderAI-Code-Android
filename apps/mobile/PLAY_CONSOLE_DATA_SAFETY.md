...
Use this checklist when submitting **RemiMinder** (`com.remiminder.app`). Align answers with the live app and [privacy-policy.html](../../privacy-policy.html).
...
1. Production `google-services.json` for `com.remiminder.app` in `android/app/`
