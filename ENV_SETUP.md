...
2. [Firebase Console](https://console.firebase.google.com/) → project **stunning-ripsaw-480402-i4** → Project settings → Your apps → Android app **`com.remiminder.app`** → **Add fingerprint** → paste SHA-1.
